...
class Ui_explicacion1(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "<html><head/><body><p align=\"justify\"><span style=\" font-size:18pt; font-weight:600;\">aidTalk</span><span style=\" font-size:18pt;\"> es un sistema texto-a-voz controlado con la vista y con la cabeza que permite que personas grandes dependientes puedan comunicarse de una manera lo más natural posible y fluida.</span></p><p align=\"justify\"><br/></p><p align=\"justify\"><span style=\" font-size:18pt; font-weight:600;\">aidTalk </span><span style=\" font-size:18pt;\">permite controlar un cursor sobre un teclado diseñado para facilitar la comunicación. El control del teclado puede efectuarse de dos maneras:</span></p><p align=\"justify\"><br/></p><p align=\"center\"><span style=\" font-size:24pt; font-weight:600;\">Control con la vista</span></p><p align=\"center\"><br/></p><p align=\"center\"><span style=\" font-size:24pt; font-weight:600;\">Control con la cabeza</span></p></body></html>"))
