...
class explanation1(QDialog):
    def __init__(self):
        super(explanation1, self).__init__()
        self.ui = Ui_explicacion1()
        self.ui.setupUi(self)

class explanation2(QDialog):
    def __init__(self):
        super(explanation2, self).__init__()
        self.ui = Ui_explicacion2()
        self.ui.setupUi(self)
        
class explanation3(QDialog):
    def __init__(self):
        super(explanation3, self).__init__()
        self.ui = Ui_explicacion3()
        self.ui.setupUi(self)
        
class explanation4(QDialog):
    def __init__(self):
        super(explanation4, self).__init__()
        self.ui = Ui_explicacion4()
        self.ui.setupUi(self)
        
class explanation5(QDialog):
    def __init__(self):
        super(explanation5, self).__init__()
        self.ui = Ui_explicacion5()
        self.ui.setupUi(self)

class ExplanationWindows(QStackedWidget):
    def __init__(self, mainClass):
        super(ExplanationWindows, self).__init__()
        
        self.parent = mainClass
        
        self.addWidget(explanation1())
        self.addWidget(explanation2())
        self.addWidget(explanation3())
        self.addWidget(explanation4())
        self.addWidget(explanation5())
        self.cont = 0
...
class CloseWindow(QDialog):
    ...
    def close(self):
        self.parent.thread.getMouseControl = False
        self.timer.start(3000) # 4 seconds
    ...
    def keyPressEvent(self, event):
        ...
        # For changing to visualization mode
            ...
            if self.explanationWindows.cont >= 5:
                ...
                self.explanationWindows.setCurrentIndex(self.explanationWindows.currentIndex()+1)
...
#     app = QApplication(sys.argv)
#     # print("bb")
#     #print(app.desktop().screen(MONITOR_SOURCE))
#     # print("cc")
#     a = aidTalkApp(app.screens()[MONITOR_SOURCE])
#     #a.show()
#     sys.exit(app.exec_())
